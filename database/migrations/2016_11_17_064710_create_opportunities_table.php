...
class CreateOpportunitiesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Opportunities", 'opportunities', 'name', 'fa-lightbulb-o', [
            ...
            ["Organisation", "Organisation", "Dropdown", false, "", 0, 0, true, "@organizations"],
            ["contact", "Contact", "Dropdown", false, "", 0, 0, true, "@contacts"],
            ["amount", "Amount", "Integer", false, "", 0, 11, false],
            ["expected_close_date", "Expected close date", "Date", false, "", 0, 0, false],
            ["next_step", "Next stap", "TextField", false, "", 0, 256, false],
            ["assigned_to", "Assigned to", "Dropdown", false, "", 0, 0, false, "@contacts"],
            ["type", "Type", "Radio", false, "", 0, 0, false, ["Existing Business","New Business"]],
